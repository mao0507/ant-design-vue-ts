<template>
  <a-row>
    ...
    <canvas ref="lineChartEl"></canvas>
      ...
      <CardView :title="'DashBoard'" :paddingLeft="10" :paddingRight="10" :paddingBottom="10" :paddingTop="10">
        <canvas ref="lineChartEl"></canvas>
      </CardView>
    </a-col>
    <a-col :span="12">
      <CardView :title="'在線人數'" :paddingLeft="10" :paddingRight="10" :paddingBottom="10" :paddingTop="10">
